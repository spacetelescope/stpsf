...
from .utils import measure_strehl, restart_logging, setup_logging, system_diagnostic
...
class Conf(_config.ConfigNamespace):
    ...
    logging_format_screen = _config.ConfigItem('[%(name)7s] %(message)s', 'Format for lines logged to the screen.')
